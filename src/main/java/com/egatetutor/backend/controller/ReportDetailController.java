...
public class ReportDetailController {
    ...
    public ResponseEntity<List<QuestionAnalysis>> getQuestionAnalysis(@RequestParam("user_id") Long userId,
 ...
 */
            ...
            throws Exception
    {
        ...
        if(!user.isPresent()) { throw new Exception("User doesn't exist"); }
        if(!coursesDescription.isPresent()){ throw new Exception("Course/Test doesn't exist"); }
